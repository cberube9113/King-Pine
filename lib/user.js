...
// **Returns**  
// &nbsp;&nbsp;*integer* 0 if user does not exist, 1 if user exists
//    </div>  
...
// ##nameFromUsername
// Given a username, this function looks up the corresponding real name.
//	  <div class="highlight">
// **Params**  
...
exports.nameFromUsername = function(username){
	var name;
	for(var i = 0; i < userdb.length; i++) {
		if(userdb[i].username === username){
			name = userdb[i].name;
...
// ##unLookup
//Resolves username value given uid.  
//    <div class="highlight">
// **Params**  
// &nbsp;&nbsp;**uid** User's ID 
// **Returns**  
